...
public class AddPFac extends javax.swing.JFrame {
    ...
    public AddPFac() {
        ...
        txtOtherPost.setVisible(false);
        lblOP.setVisible(false);
    }
    
    // Creating Instance
    private static AddPFac instance = null;
    public static AddPFac getInstance() {
        if(instance == null)
            instance = new AddPFac();
        return instance;
    }
    ...
    private String Selection(){
        String s = comPost.getSelectedItem().toString();
        if(s.equals("Teacher") || s.equals("Admin") || s.equals("Department Coordinator") || s.equals("Principal") || s.equals("Vice Principal")){
            return s;
        } else if(s.equals("Other")){
            return txtOtherPost.getText();
        }
        return "";
    }
    ...
    private void initComponents() {
        ...
        txtOtherPost = new javax.swing.JTextField();
        ...
        jLabel28.setText("Enter Post:");

        comPost.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Teacher", "Admin", "Department Coordinator", "Principal", "Vice Principal", "Other" }));
        comPost.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comPostActionPerformed(evt);
            }
        });
        ...
        lblOP.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        lblOP.setText("Enter Other Post:");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(170, 170, 170)
                        .addComponent(comBlood1, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(80, 80, 80)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(170, 170, 170)
                        .addComponent(comPost, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jLabel28, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(80, 80, 80)
                .addComponent(lblOP, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(txtOtherPost, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(530, 530, 530)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(29, 29, 29)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(comPost, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel28, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblOP, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtOtherPost, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(39, 39, 39)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnOkMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnOkMouseClicked
        ...
        if(txtName.getText().equals("") || txtGuard.getText().equals("") || txtRegNo.getText().equals("") || txtDepart.getText().equals("") || txtCnic.getText().equals("") || txtDob.getDate().equals("") || txtAddress.getText().equals("") || txtEmail.getText().equals("") || txtMobile.getText().equals("") || txtJoin.getDate().equals("") || txtLandline.getText().equals("") || comGen.getSelectedItem().toString().equals("Select") || comNat.getSelectedItem().toString().equals("Select") || comPost.getSelectedItem().toString().equals("Select") || comHandi.getSelectedItem().toString().equals("Select") || comShift.getSelectedItem().toString().equals("Select") || comPsyco.getSelectedItem().toString().equals("Select") || comMed.getSelectedItem().toString().equals("Select") || comTrack.getSelectedItem().toString().equals("Select") || txtSalary.getText().equals("") || comPost.getSelectedItem().toString().equals("")){
    ...
    // comNatActionPerformed Action Event
    ...
    // comNatActionPerformed Action Event
    private void comPostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comPostActionPerformed
        
        if(comPost.getSelectedItem().toString().trim().equals("Other")){
            txtOtherPost.setVisible(true);
    ...
    }//GEN-LAST:event_comPostActionPerformed
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(AddPFac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> {
            new AddPFac().setVisible(true);
        });
    }
    ...
    private javax.swing.JTextField txtOtherPost;
